...
<div class="row">
    <div class="col-md-12">
       ...
       <div class="portlet box blue-madison">
          ...
          <div class="portlet-title">
              <div class="caption">
                  <i class="fa fa-gift"></i>???????? ?????????? ???????? (<?php echo $eldername;?>)
              </div>
          </div>
                                  ...
                                  <br/>
                                    ...
                                    <div class="form-group">
                                        ...
                                        * </span>
                                        ...
                                        <div class="col-md-3">
                                         <input type="text" id="txtpatientName" name="txtpatientName" data-required="1" class="form-control" placeholder="?????" readonly="readonly" value="<?php if(isset($patient_row->name)) echo $patient_row->name;else if(isset($visit_row->name)) echo $visit_row->name;?>"/>
                                      </div>
                                    </div>
                                ...
                                <div class="form-actions">
                                    <div class="row">
                                        <div class="col-md-offset-3 col-md-9">
                                            <button type="submit" class="btn blue-madison">?????</button>
                                            <button type="button" class="btn default" 
                                            onclick="window.location='<?php echo base_url()?>patients/';">????</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
